...
Create a database called "giftapp"
...
Create a table called 'users'. If you want to create a different table, you can, you just have to change the query in DBTest. 
For example, my query was:
...
Then add in a user (or multiple)
...
The password should match the password for the PostgreSQL user
